...
EXEC SP_ADDEXTENDEDPROPERTY 'MS_DESCRIPTION', 'CRIA플O DA TABELA PARA ARMAZENAR OS USUARIOS','SCHEMA', [DBO], 'TABLE', [TB_USUARIO_USUA];
...
EXEC SP_ADDEXTENDEDPROPERTY 'MS_DESCRIPTION', 'CRIA플O DA TABELA PARA ARMAZENAR OS DADOS DA MAQUINA','SCHEMA', [DBO], 'TABLE', [TB_MAQUINA_MAQU];
...
EXEC SP_ADDEXTENDEDPROPERTY 'MS_DESCRIPTION', ' CRIA플O DA TABELA PARA VINCULAR A TABELA MAQUINA COM OS USUARIOS CONECTADOS NOS SERVIDORES','SCHEMA', [DBO], 'TABLE', [TB_MAQUINA_USUARIO_MAUS]
...
EXEC SP_ADDEXTENDEDPROPERTY 'MS_DESCRIPTION', 'CRIA플O DA TABELA PARA COLETAR OS DADOS DA MAQUINA','SCHEMA', [DBO], 'TABLE', [TB_COLETA_DADOS_CODA];
...
EXEC SP_ADDEXTENDEDPROPERTY 'MS_DESCRIPTION', 'CRIA플O DA TABELA PARA COLETAR OS PROCESSOS DA MAQUINA','SCHEMA', [DBO], 'TABLE', [TB_PROCESSOS_MAQUINA_PRMA];
...
SELECT ID_MAQU_CD_MAQUINA FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_NOME = 'GUIDE-PC';

SELECT * FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_NOME = 'GUIDE-PC';
/*
SELECT * FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_MAC_ADDRESS = '80:56:F2:F4:39:A9';
SELECT ID_MAQU_CD_MAQUINA FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_NOME = 'GUIDE-PC';
SELECT * FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_NOME = 'GUIDE-PC';
	
SELECT ID_MAQU_CD_MAQUINA FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_NOME = 'MTZNOTFS012381';
SELECT ID_MAQU_CD_MAQUINA FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_MAC_ADDRESS = '4C:ED:FB:CA:B7:96';

SELECT MAQU_NOME FROM  [DBO].[TB_MAQUINA_MAQU] WHERE MAQU_NOME = 'GUIDE-PC';
